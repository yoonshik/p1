...
public class ServerTestMulti2
{
	...
	private final int numTrials = 10;

	@Test
	public void testExtensive() throws Exception {
		int minSellers = 80, maxSellers = 100;
		int minBuyers = 80, maxBuyers = 320;
		
		for (int j = minSellers; j < maxSellers; j++) {
			for (int k = minBuyers; k < maxBuyers; k++) {
				for (int i = 0; i < numTrials; i++) {
					setUp();
					System.out.println("Test Extensive: " + j + " sellers, " + k + " buyers: take " + i);
					testMultiThread(0, j, k);
				}
			}
		}
	}
	...
	//		for (int i = 0; i < numTrials; i++) {
	//			setUp();
	//			System.out.println("Test 0: take " + i);
	...
	//		for (int i = 0; i < numTrials; i++) {
	//			setUp();
	//			System.out.println("Test 1: take " + i);
	...
	//		for (int i = 0; i < numTrials; i++) {
	//			setUp();
	//			System.out.println("Test 2: take " + i);
	...
	//		for (int i = 0; i < numTrials; i++) {
	//			setUp();
	//			System.out.println("Test 3: take " + i);
...
//		for (int i = 0; i < numTrials; i++) {
//			setUp();
//			System.out.println("Test 4: take " + i);
